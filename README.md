...
# WebGUI LSA LSI Storage Authority Software for controllers Megaraid/LSI/Avago/Broadcom on Linux and repacking packages .deb 
  + remote control for LSA servers via pseudoGUI
# ПО WebGUI LSA LSI Storage Authority для контроллеров Megaraid/LSI/Avago/Broadcom в Linux и переупаковка пакетов .deb 
  + удаленное управление для LSA серверов через псевдоGUI
